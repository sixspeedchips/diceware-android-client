...
public class PassphraseAdapter extends RecyclerView.Adapter<Holder> {
  ...
  public interface OnPassphraseClickListener {
    ...
    void click(View view, int listPosition, Passphrase passphrase);
  }

  @FunctionalInterface
  public interface OnPassphraseContextClickListener {

    void longPress(Menu menu, int position, Passphrase passphrase);
  }
    ...
    private void bind(int position, Passphrase passphrase) {
      ...
      if (clickListener != null) {
        view.setOnClickListener((view) -> {
          clickListener.click(view, position, passphrase);
        });
      }

      if (contextClickListener != null) {
        view.setOnCreateContextMenuListener((menu, view, menuInfo) -> {
          contextClickListener.longPress(menu, position, passphrase);
        });
      }
    }
